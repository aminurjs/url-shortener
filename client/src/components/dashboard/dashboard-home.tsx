"use client";
import { CalendarCheck, Check, Link, MousePointerClick } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-md p-5 grid grid-cols-2 gap-5 shadow-sm">
        <div className="rounded-md  flex items-center border border-muted">
          ...
          <div className="flex items-center justify-center flex-col gap-3 w-1/2 ">
            <h4 className="text-primary font-medium">Make URL is short</h4>
            <Button variant={"outline"} size={"sm"} className="text-xs px-8">
              Go to link
            </Button>
          </div>
        </div>
        <div className="rounded-md  flex items-center border border-muted">
          <div className="w-1/2 px-2 bg-gray-100">
            <Image src="/assets/dashboard/dashboard_qrcs.png" alt="link" width={600} height={400} />
          </div>
          <div className="flex items-center justify-center flex-col gap-3 w-1/2 ">
            <h4 className="text-primary font-medium">Make it scannable</h4>
            <Button variant={"outline"} size={"sm"} className="text-xs px-8">
              Go to link
            </Button>
          </div>
      ...
      <div className="bg-white rounded-md p-5 grid grid-cols-3 gap-5 shadow-sm">
        <div className="bg-slate-50 rounded-md p-5">
          <h3 className="font-medium text-lg text-muted-foreground">All URls</h3>
        ...
        <div className="bg-green-50 rounded-md p-5">
          <h3 className="font-medium text-lg text-muted-foreground">Total Clicks</h3>
          <div className="flex items-center justify-between">
            <h4 className="text-primary text-xl">0</h4>
            <span className="rounded-full p-2 bg-white">
        ...
        <div className="bg-blue-50 rounded-md p-5">
          <h3 className="font-medium text-lg text-muted-foreground">Links added this month</h3>
          <div className="flex items-center justify-between">
            <h4 className="text-primary text-xl">0</h4>
            <span className="rounded-full p-2 bg-white">
      ...
      <div className="flex gap-6">
        ...
        <div className="w-1/3">
          <div className="bg-white rounded-md p-5 shadow-sm">
            {" "}
            <h2 className="text-lg font-semibold text-primary mb-2">Upgrade Your Plan</h2>
