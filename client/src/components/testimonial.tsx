...
export function Testimonials() {
  return (
    <div className="py-12 bg-slate-50">
      ...
      <div className="flex gap-12 flex-col relative z-20  max-w-7xl overflow-hidden  [mask-image:linear-gradient(to_right,transparent,white_20%,white_80%,transparent)]">
